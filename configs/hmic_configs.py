...
def configs():
    ...
    parser.add_argument('--dataset',                type=str,   default='hmic')
    parser.add_argument('--config',                 type=str,   default='')
    parser.add_argument('--is_training',            type=str,   default='True')
    parser.add_argument('--data_train_path',        type=str,   default='data/hmic/train/hmic_train.npy')
    parser.add_argument('--data_val_path',          type=str,   default='data/hmic/val/hmic_val.npy')
    parser.add_argument('--data_test_path',         type=str,   default='data/hmic/test/hmic_test.npy')
    parser.add_argument('--input_length',           type=int,   default=12)
    parser.add_argument('--real_length',            type=int,   default=24)
    ...
    parser.add_argument('--save_dir',               type=str,   default='models/hmic')
    parser.add_argument('--gen_frm_dir',            type=str,   default='results/hmic/')
