...
def configs():
    ...
    parser.add_argument('--data_test_path', type=str, default='data/caltech/test.txt')
    ...
    parser.add_argument('--num_save_samples', type=int, default=3)
    parser.add_argument('--n_gpu', type=int, default=1)
    parser.add_argument('--pretrained_model', type=str, default='pretrained models/caltech/cal_model_recall.ckpt-1')
    parser.add_argument('--perforamnce_dir', type=str, default='results/caltech/')
    parser.add_argument('--save_dir', type=str, default='')
    parser.add_argument('--gen_frm_dir', type=str, default='results/caltech/')
